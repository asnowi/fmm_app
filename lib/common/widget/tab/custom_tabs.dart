...
class _TabBarState extends State<TabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    // final List<Widget> wrappedTabs = List(widget.tabs.length);
    final List<Widget> wrappedTabs = []..length = widget.tabs.length;
...
class TabPageSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color fixSelectedColor = selectedColor ?? ThemeData.light().colorScheme.primary;
